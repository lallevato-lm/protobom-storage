...
CREATE TABLE `new_annotations` (
  ...
  CONSTRAINT `annotations_nodes_annotations` FOREIGN KEY (`node_id`) REFERENCES `nodes` (`id`) ON DELETE SET NULL
);
-- Copy rows from old table "annotations" to new temporary table "new_annotations"
INSERT INTO `new_annotations` (`id`, `name`, `value`, `is_unique`, `document_id`, `document_annotations`) SELECT `id`, `name`, `value`, `is_unique`, `document_id`, `document_annotations` FROM `annotations`;
